...
CSprite::CSprite()
{}
void CSprite::Init(LPD3DXSPRITE SpriteHandler, LPWSTR FilePath, int Width, int Height, int Count, int SpritePerRow)
{
	D3DXIMAGE_INFO info; 
	HRESULT result; 
...
void CSprite::Draw(int X, int Y, int vpx, int vpy)
{
	RECT srect;
